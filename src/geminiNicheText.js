...
function nicheRules(niche) {
  if (niche === 'buyer_education') {
    return {
      ...
      purpose: 'practical home-buyer education, inspection awareness, apartment/villa buying checks and risk avoidance',
      visualWorld: 'real apartment and villa visits, parking areas, lifts, common areas, utility spaces, water tanks, electrical panels, doors, windows, bathrooms, kitchens, balconies, documents and realistic Coimbatore/Tamil Nadu neighbourhoods',
      cautions: 'Do not invent project approvals, builder claims, maintenance charges, legal status, dimensions, prices, loan eligibility, amenities or safety compliance. Present unsupported points as checks the buyer should verify before purchase.'
    };
  }
